 ...
 * ├───────┼─────┼─────┼─────┼─────┼─────┼───────┘ └───────┼─────┼─────┼─────┼─────┼─────┼───────┤
 * │ LSFT  │  Z  │  X  │  C  │  V  │  B  │                 │  N  │  M  │ , < │ . > │ / ? │ EQUAL │
 * ├───────┼─────┼─────┼─────┼─────┼─────┘                 └─────┼─────┼─────┼─────┼─────┼───────┤
 * │       │     │ L⎇  │ L⌘  │LT_SP│                             │LT_BS│LSFT │     │     │       │
 * └───────┴─────┴─────┴─────┴─────┘                             └─────┴─────┴─────┴─────┴───────┘
 *                               ┌───────────────┐ ┌───────────────┐
 *                               │               │ │               │
 *                       ┌───────┼───────┬───────┤ ├───────┬───────┼───────┐
 ...
 *                                                                      generated by [keymapviz] */
    [_BASE] = LAYOUT_moonlander(
        KC_ESC,    KC_1,     KC_2,      KC_3,      KC_4,        KC_5,  _______,       _______,  KC_6,  KC_7,       KC_8,     KC_9,    KC_0,    KC_TILD ,
        KC_TAB,    KC_Q,     KC_W,      KC_E,      KC_R,        KC_T,  _______,       _______,  KC_Y,  KC_U,       KC_I,     KC_O,    KC_P,    KC_MINUS,
        OSM_LCTL,  KC_A,     KC_S,      KC_D,      KC_F,        KC_G,  _______,       _______,  KC_H,  KC_J,       KC_K,     KC_L,    KC_SCLN, KC_QUOT,
        OSM_LSFT,  KC_Z,     KC_X,      KC_C,      KC_V,        KC_B,                           KC_N,  KC_M,       KC_COMM,  KC_DOT,  KC_SLSH, KC_EQUAL,
        _______,   _______,  KC_LALT,   LT_ESC,    LT_SPC,             _______,       _______,         LT_BSPC,    OSM_LSFT, _______, _______, _______,
                                                   KC_CAPS,  _______,  _______,      _______,  _______,  KC_ENTER
    ),
/* ┌───────┬─────┬─────┬─────┬─────┬─────┬───────┐ ┌───────┬─────┬─────┬─────┬─────┬─────┬───────┐
 * │       │     │     │     │     │     │       │ │       │     │     │     │     │     │       │
 * ├───────┼─────┼─────┼─────┼─────┼─────┼───────┤ ├───────┼─────┼─────┼─────┼─────┼─────┼───────┤
 ...
 *                                                                      generated by [keymapviz] */
    [_LOWER] = LAYOUT_moonlander(
        ...
        _______,  KC_ESC,  KC_TILD, KC_GRV,  KC_LBRC, KC_LCBR,                                                    KC_RCBR, KC_RBRC,  KC_VOLD, KC_VOLU,  KC_MUTE, _______,
        _______,  _______, _______, _______, LOWER,             _______,                                _______,            ADJUST,  _______, _______,  _______, _______,
 ...
 *                                                                      generated by [keymapviz] */
    [_RAISE] = LAYOUT_moonlander(
        ...
        _______,  KC_ESC,  KC_TILD, KC_GRV,  KC_LBRC, KC_LCBR,                                                 KC_RCBR, KC_RBRC, _______, _______, _______, KC_BSLASH,
